...
var task0Info = {
    ...
    finished: false,
    duplicate: false,
    deadline: (new Date(2023, 1, 10, 17, 0)).getTime(),
    required_time: 5,
    days: 2,
    auto_scheduled: true,
    specified_time: null,
...
var task1Info = {
    ...
    finished: false,
    duplicate: false,
    deadline: (new Date(2023, 1, 10, 12, 0)).getTime(),
    required_time: 1,
    days: 1,
    auto_scheduled: true,
    specified_time: null,
...
var task2Info = {
    ...
    finished: false,
    duplicate: false,
    deadline: (new Date(2023, 1, 10, 23, 55)).getTime(),
    required_time: null,
    days: 1,
    auto_scheduled: false,
    specified_time: [[(new Date(2023, 1, 10, 12, 15)).getTime(), (new Date(2023, 1, 10, 15, 0)).getTime()]],
    unit_time: 1,
    repeat_unit: "?",
    importance: 1,
    place: "?",
...
var task3Info = {
    ...
    finished: false,
    duplicate: false,
    deadline: (new Date(2023, 1, 9, 0, 0)).getTime(),
    required_time: 1,
    days: 1,
    auto_scheduled: true,
    specified_time: null,
